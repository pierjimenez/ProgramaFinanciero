...
<s:form action="saveProgramaAction" id="grupoform" onsubmit="mostrarGuardando()" theme="simple">
...
<tr>
	<td>
						...
						<tr>
							...
							<td>
								<s:textfield name="codigoEmpresaGrupo"
															 ...
															 onblur="javascript:buscarGrupoEmpresa();"
															 theme="simple"
															 maxlength="11"
															 cssClass="validate[required] "
		...
		<div id="divempresas" style="display:">
			<table>
				<tr>
					...
					<td>
						<s:select  name="empresaPrincipal.codigo" list="listaGrupoEmpresas"  listKey="codigo" listValue="nombre" theme="simple"></s:select>
					</td>
				</tr>
				<tr>
					<td class="label">
					...
					<select multiple="multiple" id="selListaEmpresasAnexas" name="selListaEmpresasAnexas" size="15">
						<s:iterator value="listaGrupoEmpresas">
						    <option value="<s:property value="codigo"/>"><s:property value="nombre"/></option>
					    </s:iterator>
					</select>					
		...
		<table>
			<tr>
				<td>
					<s:submit theme="simple" value="Guardar" cssClass="btn"></s:submit>
				</td>
			</tr>
		</table>
	</td>
