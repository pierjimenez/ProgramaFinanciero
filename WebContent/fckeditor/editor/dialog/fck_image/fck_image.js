...
function UpdateOriginal( resetSize )
{
	...
	//eImgPreview.src = oImageOriginal.src;
...
function ResetSizes()
{
	...
	document.getElementById( 'imagenCargado' ).style.display  = '' ;
...
function OnUploadCompleted( errorNumber, fileUrl, fileName, customMsg )
{
	...
	document.getElementById( 'imagenInicial' ).style.display  = 'none' ;
	document.getElementById( 'imagenCargando' ).style.display  = '' ;
	document.getElementById( 'imagenCargado' ).style.display  = 'none' ;
