...
@Service("loadDepositoAplazoDAO")
public class LoadDepositoAplazoDAOImpl extends LoadGenericDao<Programa> implements LoadDepositoAplazoDAO{
Logger logger = Logger.getLogger(this.getClass());
	
	@Autowired	
	public LoadDepositoAplazoDAOImpl(SessionFactory sessionFactory) {
