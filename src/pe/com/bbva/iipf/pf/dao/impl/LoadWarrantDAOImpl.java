...
@Service("loadWarrantDAO")
public class LoadWarrantDAOImpl extends LoadGenericDao<Programa> implements LoadWarrantDAO{
Logger logger = Logger.getLogger(this.getClass());
	
	@Autowired	
	public LoadWarrantDAOImpl(SessionFactory sessionFactory) {
