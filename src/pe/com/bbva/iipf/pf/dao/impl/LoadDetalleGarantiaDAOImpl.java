...
@Service("loadDetalleGarantiaDAO")
public class LoadDetalleGarantiaDAOImpl extends LoadGenericDao<Programa> implements LoadDetalleGarantiaDAO{
Logger logger = Logger.getLogger(this.getClass());
	
	@Autowired	
	public LoadDetalleGarantiaDAOImpl(SessionFactory sessionFactory) {
