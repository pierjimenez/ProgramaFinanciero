...
@Service("loadHipotecaDAO")
public class LoadHipotecaDAOImpl extends LoadGenericDao<Programa> implements LoadHipotecaDAO{
Logger logger = Logger.getLogger(this.getClass());
	
	@Autowired	
	public LoadHipotecaDAOImpl(SessionFactory sessionFactory) {
