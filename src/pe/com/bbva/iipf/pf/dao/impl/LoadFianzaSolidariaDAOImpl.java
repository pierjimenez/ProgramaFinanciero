...
@Service("loadFianzaSolidariaDAO")
public class LoadFianzaSolidariaDAOImpl extends LoadGenericDao<Programa> implements LoadFianzaSolidariaDAO{
Logger logger = Logger.getLogger(this.getClass());
	
	@Autowired	
	public LoadFianzaSolidariaDAOImpl(SessionFactory sessionFactory) {
