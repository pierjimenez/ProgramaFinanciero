...
@Service("generarPDFAction")
@Scope("prototype") 
public class GenerarPDFAction extends GenericAction {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6199783025915325568L;
...
//							sb.append("<br/>");	
    ...
    public String descargarPDFGeneral() throws Exception {
    		...
    		System.out.println(codigoTipoOperacion);
    		...
    		try {
    			...
    			logger.info("ini getInputStream setContentType");
    	    	...
    	    	logger.info("fin getInputStream setContentType");
    		} catch (BOException e) {		
    ...
    public String descargarPDFGeneral2() throws Exception {
