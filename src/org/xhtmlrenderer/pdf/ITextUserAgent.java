...
public class ITextUserAgent extends NaiveUserAgent {
    ...
    public String getURILocal(String uri){
    	String res="";
    	   String url_upload=Utilities.DIR_UPLOADFILE_URL_IMG;
           String url_upload_ErrorImg=url_upload.concat("/ErrorImagenBlack.png");           
           int posicion = uri.indexOf(url_upload);
           if (posicion==-1){					
        	   res= url_upload_ErrorImg;									
			}else{
				res=uri;
			}
